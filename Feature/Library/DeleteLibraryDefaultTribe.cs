...
{
    public class DeleteLibraryDefaultTribe
    {
        private readonly IMediator _mediator;

        public DeleteLibraryDefaultTribe(IMediator mediator) => _mediator = mediator;

        public class DeleteLibraryDefaultTribeCommand : IRequest<string>
        {
            public string HubId { get; set; }
            public string LibraryId { get; set; }

            public DeleteLibraryDefaultTribeCommand(string hubId, string libraryId)
            {
                HubId = hubId;
                LibraryId = libraryId;
            }
        ...
        public class DeleteLibraryDefaultTribeCommandHandler : IRequestHandler<DeleteLibraryDefaultTribeCommand, string>
        {
            public readonly LibraryContext _db;
            private readonly MapperConfiguration _mapperConfiguration;
            private readonly IMediator _mediator;

            public DeleteLibraryDefaultTribeCommandHandler(LibraryContext db, IMediator mediator)
            {
                _db = db;
                _mediator = mediator;
            ...
            public async Task<string> Handle(DeleteLibraryDefaultTribeCommand cmd, CancellationToken cancellationToken)
            {
